...
-- changeset onish:1756857397782-1
...
-- changeset onish:1756857397782-2
CREATE TABLE advertisement
(
    id                       BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    email                    VARCHAR(255),
    paid_promotional         BOOLEAN                                 NOT NULL,
    status                   VARCHAR(255),
    address_id               BIGINT,
...
-- changeset onish:1756857397782-3
...
(
    ...
    CONSTRAINT pk_apartmentdescription PRIMARY KEY (id)
);

-- changeset onish:1756857397782-4
CREATE TABLE users
(
    id           BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    name         VARCHAR(255),
...
-- changeset onish:1756857397782-7
ALTER TABLE advertisement
